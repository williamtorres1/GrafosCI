...
function changerobot() {
    ...
    window.nodesSet = new vis.DataSet([
	    ...
	    {level: 1, id: 'DSCO00038', label: 'Introdução à E.R', title: '1107248 INTRODUÇÃO À ROBÓTICA', y: -900},
	    ...
	    {level: 4, id: 'GDSCO0062', label: 'Redes I', title: 'GDSCO0062 REDES DE COMPUTADORES I', y: -800},
			{level: 4, id: 'GDSCO0064', label: 'Sinais e Sistemas', title: 'GDSCO0064 SINAIS E SISTEMAS DINÂMICOS', y: -700},
